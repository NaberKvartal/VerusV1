    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <label>Основна інформація
                <input class="form-control" style="width: 200px;" placeholder="ID Ідеї" id="id_idea"  value="<?php echo $_GET['id_idea']; ?>">
                <input class="form-control" style="width: 200px;" placeholder="ID Автора" id="id_author">
                <input class="form-control" style="width: 200px;" placeholder="Посадка будинків" id="build">
