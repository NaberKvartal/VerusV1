...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li class="active"><a href="/people">Користувачі</a></li>
                <!--                <li><a href="">- Add item</a></li>-->
            </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <!--    <h1 class="page-header">Dashboard</h1>-->
            <input class="form-control" style="width: 200px;" placeholder="Ім'я" id="name" value="<?php echo $person['name']; ?>"><br>
            <input class="form-control" style="width: 200px;" placeholder="Прізвище" id="surname" value="<?php echo $person['surname']; ?>"><br>
            <div class="btn btn-lg btn-primary" onclick="editPerson(<?php echo $person_id; ?>);">Редагувати користувача</div>
        </div>
...
<?php require_once('../include/people_js.php'); ?>
</body>
</html>